...
export const itemsOfInterest = [
  {
    ...
    "address": "Osun-Osogbo Grove Rd, Osogbo, Osun State",
    "description": "A UNESCO World Heritage site featuring ancient sculptures, shrines, and a sacred river dedicated to the goddess Osun.",
    "estimated_cost": "₦1,000 - ₦2,000",
    "image": "osun-osogbo-grove.webp"
  },
  {
    "id": 2,
    "name": "Erin-Ijesha (Olumirin) Waterfalls",
    "address": "Erin-Ijesha, Oriade LGA, Osun State",
    "description": "A breathtaking natural wonder with seven distinct levels of cascading water nestled within a lush forest.",
    "estimated_cost": "₦1,000 (Adults), ₦500 (Children)",
    "image": "erin-ijesha-falls.webp"
  },
  {
    "id": 3,
    "name": "Ooni of Ife Palace",
  ...
  {
    "id": 7,
    "name": "MicCom Golf Hotels & Resort",
